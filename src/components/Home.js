...
const Home = props =>
  <div className="home">
    <div>
      <h1 itemProp="headline">Webrtc Video Room 1984</h1>
      <p>Please enter a room name.</p>
      <input type="text" style={{color: 'red'}} name="room" value={ props.roomId } onChange={props.handleChange} pattern="^\w+$" maxLength="10" required autoFocus title="Room name should only contain letters or numbers."/>
